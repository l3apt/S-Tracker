...
$manager = new TswimmingManager($db);
?>
<!DOCTYPE HTML>
<!--
        ...
        <!-- Nav -->
          <nav id="nav">
            <ul class="links">
              ...
              <li class="active"><a href="Swimming.php">Swimming</a></li>
        ...
        <!-- Main -->
          <div id="main">
            ...
            <!-- Entête -->
                <header class="major">
                  <h1>SWIMMING</h1>
                  <div class="image main"><img src="images/baniere_swimming.jpg" alt="" /></div>
          ...
          {
            echo '</header>';
            echo '<form method="post" action="Swimming.php?ajouter=1">'; ?>
                <div class="fields">
                  <div class="field">
          ...
          if (isset($_GET['modifier']) && isset($_GET['id']))
          {
           ...
           /* Si les détails d'un track sont demandés, on peut le modifier par formulaire  */
            if (isset($_GET['id']))
              ...
              echo '<form method="post" action="Swimming.php?modifier=', $tracks->id(),'&id=',$_GET['id'],'&nb=',$_GET['nb'],'">'; ?>
                <div class="fields">
                  <div class="field">
                    <label for="date_course">Date</label>
                    <input type="date" name="date_course" 
