...
$manager = new TrunningManager($db);
?>
<!DOCTYPE HTML>
<!--
				...
				<!-- Main -->
					<div id="main">
						...
						<!-- Entête -->
								<header class="major">
									<h1>RUNNING</h1>
									<div class="image main"><img src="images/baniere_running.jpg" alt="" /></div>
					...
					{
					  echo '</header>';
					  echo '<form method="post" action="running.php?ajouter=1">'; ?>
								<div class="fields">
									<div class="field">
									...
									<div class="field">
										...
										<input type="number" name ="km" min ="0" max ="20" step="0.01"/>
									</div>
									<div class="field">
					...
					if (isset($_GET['modifier']) && isset($_GET['id']))
					{
					 ...
					 /* Si les détails d'un track sont demandés, on peut le modifier par formulaire  */
						if (isset($_GET['id']))
						  ...
						  echo '<form method="post" action="running.php?modifier=', $tracks->id(),'&id=',$_GET['id'],'&nb=',$_GET['nb'],'">'; ?>
								<div class="fields">
									<div class="field">
										<label for="date_course">Date</label>
										<input type="date" name="date_course" 
